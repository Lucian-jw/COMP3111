...
public class Course {
     ...
     * @return a boolean value that indicates if this course contains a LAB or Tutorial slot
     * @author JIANG WEI
     */
     ...
     * @return a boolean value that indicates if this course contains a Saturday slot
     * @author JIANG WEI
     */
     ...
     * @return a boolean value that indicates if this course contains a Thursday slot
     * @author JIANG WEI
     */
     ...
     * @return a boolean value that indicates if this course contains a Wednesday slot
     * @author JIANG WEI
     */
